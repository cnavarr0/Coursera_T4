...
public class BaseDatos extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
      ...
      /*  String queryCrearTablaLikesContacto = "CREATE TABLE " + ConstantesBaseDatos.TABLE_LIKES_CONTACT + "(" +
        ...
        Log.i("TAG_Se creo TablaContacto ", "Se creo TablaContacto"+queryCrearTablaContacto);

        db.execSQL(queryCrearTablaLikesContacto);
        Log.i("TAG_Se creo TablaLikesContacto ", "Se creo TablaLikesContacto"+queryCrearTablaLikesContacto);
    }
    ...
    public int obtenerLikesContacto(Contacto contacto){
        ...
        db.close();
        Log.i("TAG_Numero de likes", "Numero de likes: "+likes);
